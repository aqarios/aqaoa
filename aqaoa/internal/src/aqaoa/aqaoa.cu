...
void core_aqaoa(AqAOAHandle *handle, size_t numNodes, size_t depth,
...
cuDoubleComplex *statevector_aqaoa(AqAOAHandle *handle, size_t numNodes,
  ...
  core_aqaoa(handle, numNodes, depth, polykeys, polyvals, polysize, betas,
             gammas, blockSize, rxmethod);
  return retrieveStatevector(handle);
}

double expectation_value_aqaoa(AqAOAHandle *handle, size_t numNodes,
...
SampleSet sample_aqaoa(AqAOAHandle *handle, size_t numNodes, size_t depth,
                       size_t *polykeys, double *polyvals, size_t polysize,
...
void inner_gradients_aqaoa(AqAOAHandle *handle, size_t numNodes, size_t depth,
                           size_t *polykeys, double *polyvals, size_t polysize,
...
Gradient gradients_aqaoa(AqAOAHandle *handle, size_t numNodes, size_t depth,
                         size_t *polykeys, double *polyvals, size_t polysize,
                         const double *betas, const double *gammas,
                         size_t blockSize, const char *rxmethod) {
  Gradient grads;
  ...
  inner_gradients_aqaoa(handle, numNodes, depth, polykeys, polyvals, polysize,
