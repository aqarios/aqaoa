...
AOAStatevectorResult statevecAqaoaWrapper(AqAOAHandle *handle, size_t numNodes,
  ...
  result.statevector =
      statevector_aqaoa(handle, numNodes, depth, polykeys, polyvals, polysize,
...
double expvalAqaoaWrapper(AqAOAHandle *handle, size_t numNodes, size_t depth,
  ...
  double result = expectation_value_aqaoa(
...
AOAGradientsResult gradientsAqaoaWrapper(AqAOAHandle *handle, size_t numNodes,
                                         ...
                                         const char *rxmethod) {
  auto gradients =
      gradients_aqaoa(handle, numNodes, depth, polykeys, polyvals, polysize,
                      betas, gammas, blockSize, rxmethod);
...
AOASampleSet sampleAqaoaWrapper(AqAOAHandle *handle, size_t numNodes,
  ...
  auto out =
      sample_aqaoa(handle, numNodes, depth, pinnedPolynomialKeys,
