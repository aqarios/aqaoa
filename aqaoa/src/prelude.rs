...
//! AOA's prelude.
//!
//! The purpose of this module is to alleviate imports of many commonly used items of the AqAOA crate
...
pub use crate::algorithms::aqaoa::AqAOA;
...
pub use crate::bindings::aqaoa::get_cuda_devices_info;
pub use crate::bindings::aqaoa::CudaDevice;
pub use crate::bindings::aqaoa::Handle;
